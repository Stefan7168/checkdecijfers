// Fully-ingested hermetic database: register + registry defaults + sync all 8
// Phase 0 tables from the committed fixtures into a fresh PGlite instance
// (ADR 009 — CI never touches Supabase). This is the query work package's
// stand-in for the live database; the benchmark-cell coverage of the fixtures
// is itself asserted by tests/query/benchmark-intents.test.ts.
