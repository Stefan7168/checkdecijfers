...
//
// Perf (#245 Action 3, session 110): this file used to call createTestDb()
// (fresh PGlite boot) inside every one of its 10 it()s. It now boots ONE
// instance for the whole run (beforeAll/afterAll) and resets it to a
// freshly-migrated state before every test (beforeEach) instead.
