...
Work in the project root: `/Users/redacted/Projects/check-de-cijfers` (the folder containing the notes file). Create `README.md`, `CLAUDE.md`, and `docs/` there.
