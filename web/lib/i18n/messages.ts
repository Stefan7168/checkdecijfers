...
const nl = {
  ...
  // Phase 5 final review (Fix 5): one neutral key for BOTH forms that draw
  // no chart (table and heatmap, `isTabularForm`) — the old
  // `chart.copilot.tableLocked` named the table specifically, which read
  // wrong on the Warmtekaart tab.
  'chart.copilot.tabularLocked': 'In deze weergave is de chat uit: kies eerst een grafiekvorm boven de grafiek.',
  ...
  'chart.template.salmon': 'Perzikpapier',
  'chart.template.salmonDescription': 'Warm perzikkleurig papier met een roze, oker en salie-kleurig palet en een schreef-kop.',
  'chart.template.studio': 'Studio Grijs',
  'chart.template.studioDescription': 'Een rustige, warmgrijze kaart met één brandoranje accent.',
  'chart.template.broadsheet': 'Krantenpapier',
  'chart.template.broadsheetDescription': 'Bijna-wit papier, inktzwarte staven en één krantenrode accentkleur, koptekst in Georgia.',
  'chart.template.autumn': 'Herfstbrief',
  'chart.template.autumnDescription': 'Crèmekleurig papier in een herfstpalet, zacht afgeronde hoeken.',
  'chart.template.brutalist': 'Brutalistisch',
  'chart.template.brutalistDescription': 'Bijna-zwart papier met één felgroen accent en een zware koptekst.',
...
const en: Messages = {
  ...
  'chart.copilot.tabularLocked': 'The chat is off in this view: pick a chart form above the chart first.',
  'chart.copilot.cbsLocked':
  ...
  'chart.template.salmon': 'Salmon Editorial',
  'chart.template.salmonDescription': 'A warm peach paper with a rose, ochre and sage palette and a serif headline.',
  'chart.template.studio': 'Studio Grey',
  'chart.template.studioDescription': 'A quiet warm-grey card with one burnt-orange accent.',
  'chart.template.broadsheet': 'Broadsheet',
  'chart.template.broadsheetDescription': 'Near-white paper, ink-black bars and one masthead-red highlight, Georgia headline.',
  'chart.template.autumn': 'Autumn Letter',
  'chart.template.autumnDescription': 'Cream paper in an autumn palette, softly rounded corners.',
  'chart.template.brutalist': 'Brutalist Ink',
  'chart.template.brutalistDescription': 'Near-black paper with a single acid-green accent and a heavy display headline.',
