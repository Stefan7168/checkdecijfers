...
| 18 | Product | Does serving covered historical periods from a cadence-overdue table *with a staleness warning* satisfy principle 3 (c), or should it refuse outright? | Warn-and-serve assumed ([05-data-rules.md](05-data-rules.md), failure-behavior table); Stefan sign-off requested |
...
| 20 | Roadmap | Trojan-Horse demand-data reports and citation-funding/ads are marked "Recommended reject" — architect judgments, not interview decisions. | Treated as rejected unless Stefan overrules during doc review |
