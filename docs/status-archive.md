...
**Session 107, continued once more (2026-09-16/17, owner present) — the owner explicitly asked to apply the pending migrations and register a real Eurostat table (RUNBOOK "WP30c E1" steps 4-5); this surfaced a fifth real defect (in `registerTables`, never the adapter this time).**
