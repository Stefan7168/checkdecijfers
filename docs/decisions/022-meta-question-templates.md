...
## 6. Adversarial review (house rule, pre-push)

Recorded in [STATUS.md](../STATUS.md) session-18/WP18 entry after the review ran; verdict details below were added post-review in the same change.
