...
| **Parallel, positioning ([#237](open-questions.md))** | **(a) ✅ DONE, session 101 continued (2026-09-13): [ADR 047](decisions/047-repositioning-embedded-sourced-chart.md)**, with addenda on the vision Q1 and roadmap Phase 2/3. **(b) ✅ DESIGN + PLAN DONE, session 101 continued (2026-09-13):** the [#205](open-questions.md) Pro-plan brainstorm — scope, €19.99/mo · 1000 credits/period · resets, flag-gated rollout — spec'd ([superpowers/specs/2026-09-13-pro-subscription-tier-design.md](superpowers/specs/2026-09-13-pro-subscription-tier-design.md)) and planned ([superpowers/plans/2026-09-13-pro-subscription-tier.md](superpowers/plans/2026-09-13-pro-subscription-tier.md)); **build IN PROGRESS** (4/13 tasks, kept worktree `.claude/worktrees/pro-subscription-tier`, not merged — see STATUS.md). (c) Eurostat as source two through the WP30 narrow waist, demand-driven, **never named publicly before it answers** — not started. (d) ✅ DONE (ADR 046, session 98/99) — the landing page + public gallery. | (a)(b) none; (c) ingestion + registry work, no LLM; (d) none | (a) done · (b) design+plan done, build ~2-3 more sessions · (c) its own WP · (d) done | (c) needs its own design round |
