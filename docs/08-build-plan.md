...
## Journey programme — the five minutes around the answer (the experience improvement plan, [#238](open-questions.md)) + the repositioning / ICP ([#237](open-questions.md)) — ▶ NEXT UP (owner, session 96, 2026-09-11: "make sure the build plan is updated accordingly")
...
| 5 | First fetch cheaper vs larger grant | **larger grant** (config value) | no special case in the price table |
...
| 1 — the first-question bundle | R2 (clarification caption, `/credits` as a link, low-balance line + credits explainer mounted in the live workspace, purchase banner polls the balance instead of "refresh") + R11 (honest waiting copy) + R10 (credits page: cost per question, "≈ N vragen", "credits verlopen nooit"). **✅ BUILT session 96 (2026-09-11), independently, before this row and [#239](open-questions.md) were reconciled — full verification green, see [#239](open-questions.md) for the as-built detail. Pushed to `claude/checkdecijfers-embed-pr-review-acbrd5`, NOT yet merged to `main`** — re-check this note once it lands; only then is Phase 1 truly done. | none / none / none | ~1½ days | decision 3 |
