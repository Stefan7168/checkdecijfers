...
> ⏸ **PROJECT PAUSED 2026-08-15, ~2 months, expected back ~2026-10-15.** The repo was set PRIVATE at the
> same time. **Before using this brief, read the pause banner at the top of [`../STATUS.md`](../STATUS.md)
> and the RUNBOOK's "Resuming after a long pause" section** — the GDPR retention clock comes first, ahead
> of everything queued below. And run `date`: this brief was written 2026-08-07, the halt was 2026-08-15,
> and the resume is later still. Every number below is stale until you re-measure it.
