...
| 2 | BBP flash — 30 jul | `85880NED` | Bbp, productie en bestedingen; kwartalen, mutaties | both | 5 | ✅ **DONE + LIVE (s50, 2026-07-17)** — deviations from this row: FULL ingest (owner decision; the lean SoortMutaties slice was validator-refuted) + 17 phantom measures excluded ([#167](../open-questions.md)); headline is v4 code `M002782_1` (this row's `BrutoBinnenlandsProduct_2` was a v3 name). CC5-CC7 live-verified. |
| 3 | Producentenprijzen — 30 jul | `85770NED` | PPI; afzet-/invoer-/verbruiksprijzen, 2021=100 | both | 5 | ✅ **DONE + LIVE (s50, 2026-07-17)** — slice as intended (ProdCom-totaal `A052584` verified + totaal/invoer), headline v4 `M003288` (this row's `JaarmutatiePPI_3` was a v3 name). CC8-CC10 live-verified. |
